package com.example.noisemapping;
...
public class MainActivity extends Activity {
  ...
  ((Button) findViewById(R.id.btnFormat)).setText(getString(R.string.audio_format) + " (" + file_exts[currentFormat] + ")");
	...
	//    ((Button) findViewById(R.id.btnFormat)).setText(" (" + file_exts[currentFormat] + ")");
	...
	private void displayFormatDialog() {
	   ...
	   // builder.setTitle("").setSingleChoiceItems(formats, currentFormat, new DialogInterface.OnClickListener() {
